...
<template>
  <w-card title="Фильтр" bg-color="base-bg-color" class="mb4">
    <w-form class="w-flex column gap4">
      <w-select
    ...
    <template #actions>
      <div class="spacer" />
      <w-button class="mr3" bg-color="success" @click="apply"> Применить </w-button>

      <w-button class="mr3" bg-color="error" @click="reset"> Сбросить </w-button>
    </template>
  </w-card>
</template>
